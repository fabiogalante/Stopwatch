...
namespace performance_issues
{
    ...
    /// reusable code - Gabriel Lara Baptista - Hands-On Software Architecture with C# 
    /// </summary>
    class Program
    {
        ...
        {
            var menuOption = MenuOption.Exit;
            do
            {
        ...
        private static string ExecuteStringConcatenationWithNoComponent()
        {
            ...
            string valorConcantenando = String.Empty;
            for (int i = 0; i < 100000; i++)
                valorConcantenando += i.ToString();
            return $"Final result: {valorConcantenando}";
        }
